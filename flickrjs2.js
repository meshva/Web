function flickrController($scope){
	...
	$.getJSON('https://api.flickr.com/services/rest/?&method=flickr.photos.search&api_key=65c71fb9600f5393c38727c33b6b18be&tags=kanji&safe_search=1&format=json&jsoncallback=?',
   function(data){
